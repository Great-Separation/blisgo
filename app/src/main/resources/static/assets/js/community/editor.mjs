...
import Table from 'https://cdn.jsdelivr.net/npm/@editorjs/table/+esm';
import ImageTool from 'https://cdn.jsdelivr.net/npm/@editorjs/image/+esm';
import Embed from 'https://cdn.jsdelivr.net/npm/@editorjs/embed/+esm';
import CodeTool from 'https://cdn.jsdelivr.net/npm/@editorjs/code/+esm';
import Quote from 'https://cdn.jsdelivr.net/npm/@editorjs/quote/+esm';
import Delimiter from 'https://cdn.jsdelivr.net/npm/@editorjs/delimiter/+esm';
import Warning from 'https://cdn.jsdelivr.net/npm/@editorjs/warning/+esm';
import LinkTool from 'https://cdn.jsdelivr.net/npm/@editorjs/link/+esm';
import AttachesTool from 'https://cdn.jsdelivr.net/npm/@editorjs/attaches/+esm';
import Checklist from 'https://cdn.jsdelivr.net/npm/@editorjs/checklist/+esm';
import InlineCode from 'https://cdn.jsdelivr.net/npm/@editorjs/inline-code/+esm';
import Marker from 'https://cdn.jsdelivr.net/npm/@editorjs/marker/+esm';
import RawTool from 'https://cdn.jsdelivr.net/npm/@editorjs/raw/+esm';

export function init() {
    let text = document.getElementById('form').getAttribute('data-content');
    let readonly = document.getElementById('form').getAttribute('data-edit') === 'true';
